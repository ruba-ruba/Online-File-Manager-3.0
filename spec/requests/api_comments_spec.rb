...
describe FileManager::API do
  ...
  describe "GET /api/v3/folders/id/comments" do
    it "returns an empty array of folders" do
      ...
      get "/api/v3/folders/#{folder.id}/comments?token=#{user.token}"
  ...
  describe "GET /api/v3/items/id/comments" do
    it "returns an empty array of items" do
      ...
      get "/api/v3/items/#{item.id}/comments?token=#{user.token}"
      response.status.should == 200
      JSON.parse(response.body).should == []
    end
  end
  ...
  describe "GET /api/v3/items/id/comments" do
    it "returns an id for items" do
      comment = FactoryGirl.create :item_comment, :user_id => user.id
      get "/api/v3/items/#{comment.commentable_id}/comments?token=#{user.token}"
  ...
  describe "GET /api/v3/items/id/comments" do
    it "returns a content for items" do
      comment = FactoryGirl.create :item_comment, :user_id => user.id, :content => "Hello"
      get "/api/v3/items/#{comment.commentable_id}/comments?token=#{user.token}"
      response_hash = JSON.parse(response.body)[0]
  ...
  describe "GET /api/v3/items/id/comments" do
    it "returns a votes_up for items" do
      comment = FactoryGirl.create :item_comment, :user_id => user.id, :votes_up => 1
      get "/api/v3/items/#{comment.commentable_id}/comments?token=#{user.token}"
      response_hash = JSON.parse(response.body)[0]
  ...
  describe "GET /api/v3/items/id/comments" do
    it "returns a votes_down for items" do
      comment = FactoryGirl.create :item_comment, :user_id => user.id, :votes_down => 1
      get "/api/v3/items/#{comment.commentable_id}/comments?token=#{user.token}"
      response_hash = JSON.parse(response.body)[0]
  ...
  describe "GET /api/v3/items/id/comments" do
    it "returns a parent_identifier for items" do
      comment = FactoryGirl.create :item_comment, :user_id => user.id
      comment = FactoryGirl.create :item_comment, :user_id => user.id, :parent_id => comment.id  
      get "/api/v3/items/#{comment.commentable_id}/comments?token=#{user.token}"
      response_hash = JSON.parse(response.body)[0]
